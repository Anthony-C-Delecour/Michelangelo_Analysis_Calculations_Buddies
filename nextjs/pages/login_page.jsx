          ...
          <div style={styles.card}>
            ...
            <form style={styles.form} onSubmit={handleSubmit}>
              ...
              <div style={styles.buttonGroup}>
                <Button type="submit" variant="contained" style={styles.signInBtn} fullWidth>
                  Sign In
                </Button>
                <Button variant="outlined" style={styles.registerBtn} onClick={handleRegister} fullWidth>
                  Register
                </Button>
              </div>
              <Link
